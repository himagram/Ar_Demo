; (function () {
    ...
    AFRAME.registerComponent('compass-rotation', {
        ...
        handlerOrientation: function (evt) {
			...
			if(compassdir == null && event.webkitCompassHeading != null) {
				// Apple works only with this, alpha doesn't work
				compassdir = event.webkitCompassHeading;  
				alpha_alt = 360 - Number(compassdir);
			}
    ...
    AFRAME.registerComponent('road', {
        ...
        // Path
        points: [
            { latitude: 21.046368, longitude: 105.794631, altitude: 50 },
            { latitude: 21.046283, longitude: 105.795146, altitude: 60 },
            { latitude: 21.046399, longitude: 105.795743, altitude: 50 }
        ],
