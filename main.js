; (function () {
    ...
    window.addEventListener('deviceorientation', (orientation) => {
        ...
        document.querySelector("#test_el").innerText = "2orientation.alpha: " + THREE.Math.degToRad(orientation.alpha) + ";orientation.beta: " + THREE.Math.degToRad(orientation.beta) + ";orientation.gamma: " + THREE.Math.degToRad(orientation.gamma);
    });
